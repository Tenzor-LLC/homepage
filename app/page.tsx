    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Tenzor LLC delivers cutting-edge software solutions that
                transform businesses. From enterprise applications to innovative
                tools, we publish software that drives success.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive software publishing solutions tailored to your needs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition hover:border-2 hover:border-[#B8D8D8]">
              ...
              <p className="text-gray-600">
                Custom software solutions built with the latest technologies and
                best practices.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-[#B8D8D8]/30 to-[#B8D8D8]/50 p-8 rounded-2xl border-2 border-[#B8D8D8]">
              ...
              <p className="text-gray-700 mb-6">
                ...
                business management platform with CRM, analytics, and automation
                tools.
              </p>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl text-gray-900 mb-6">About Tenzor LLC</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl text-gray-900 mb-6">Ready to Get Started?</h2>
          <p className="text-xl text-gray-600 mb-8">
            Join hundreds of companies that trust Tenzor LLC for their software
            needs.
          </p>
